...
import type { RuntimeRenderedPost } from "@/server/public-posts";
...
export let sortedPosts: RuntimeRenderedPost[] = [];
...
onMount(async () => {
	let filteredPosts: RuntimeRenderedPost[] = sortedPosts;
	...
	const grouped = filteredPosts.reduce(
		...
		{} as Record<number, RuntimeRenderedPost[]>,
	);
